...
[![My Skills](https://go-skill-icons.vercel.app/api/icons?i=excel,mysql,postgresql,mongodb,python,pandas,numpy,excel,tableau,matplotlib,seaborn,plotly,scikitlearn,jupyter,airflow,aws,gcp,docker,git,github,markdown,ai,figma,framer,html,css&theme=dark&titles=true&size=500&perline=15)](https://www.linkedin.com/in/m-awaisqasim)
